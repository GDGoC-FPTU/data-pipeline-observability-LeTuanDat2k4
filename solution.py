...
==============================================================
Student ID: 2A202600382  (<-- Thay XXXX bang ma so cua ban)
Name: Le Tuan Dat
...
def validate(data):
    ...
    for record in data:
        ...
        is_category_valid = category and str(category).strip() != ""
    ...
    print(f"Validation complete. {len(valid_records)} records kept, {error_count} errors found.")
